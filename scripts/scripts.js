...
(async () => {
		...
		<div>
			<div id="left-container">
				...
				<div id="panel-2" class="panel">
					<div id="button-container-1" class="button-container">
				...
				<div id="control-button-2" class="button orange">6539-456</div>
			</div>
		</div>
		<div id="right-container">
			<div id="panel-3" class="panel">
				<a id="label" href="/federation-database">Federation Database</a>
				<div id="button-container-2" class="button-container">
	...
	document.querySelectorAll('#control-button-1, #label').forEach(b => {b.onclick = beep2});
	document.querySelectorAll('.orange').forEach(b => {b.onclick = beep3});

	const beepOne = new Audio('/federation-database/audio/beep-1.mp3');
	const beepTwo = new Audio('/federation-database/audio/beep-2.mp3');
	const beepThree = new Audio('/federation-database/audio/beep-3.mp3');
