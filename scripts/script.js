...
document.querySelector('#element-eight').outerHTML = `
  ...
  <article id="element-eight">
    ...
    <footer id="footer">
      ...
      <p>The design of the Federation Database is inspired by the LCARS design style that was created by Michael Okuda. The colors are from LCARS designs by Andrew Jarvis. All original aspects are owned by Noel Tucker and are not available under any license. All unoriginal aspects are owned by <a href="https://www.paramount.com">Paramount Skydance</a> and are used here in a way believed to qualify as fair use under United States copyright law.</p>
      ...
      <p>All Star Trek trademarks and copyrights present in the Federation Database are owned by Paramount Skydance or an affiliated entity and are used here in a way believed to qualify as fair use under United States copyright law.</p>
    </footer>
  </article>
